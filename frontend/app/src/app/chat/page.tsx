const Page = () => {
  return (
    <div className="backdrop-blur-md h-screen w-full text-gray-200 rounded-xl overflow-hidden border-2 border-gray-600">
      <div className="">
        <section className=" w-full  bg-green-400 group  transition-all duration-300 ">
          <div className="hidden header p-4 flex flex-row justify-between items-center flex-none">
  ...
  <div className="active-users flex flex-row overflow-auto">
    {[
      { id: 1, name: 'Angelina Jolie', img: 'https://randomuser.me/api/portraits/women/61.jpg' },
      { id: 2, name: 'Tony Stark', img: 'https://randomuser.me/api/portraits/men/97.jpg' },
      { id: 3, name: 'Scarlett Johan', img: 'https://randomuser.me/api/portraits/women/33.jpg' },
    ].map((user) => (
      <a
        key={user.id}
        href={`/chat/${user.id}`} // Adjust the URL structure as needed
              ...
              <div className="flex flex-row justify-start">
                ...
                <div className="messages text-sm text-gray-700 grid grid-flow-row gap-2">
                  <div className="flex items-center group">
                    <p className="px-6 py-3 rounded-t-full rounded-r-full bg-white max-w-xs lg:max-w-md text-black">
                      Hey! How are you?
                    </p>
                    <button
                      type="button"
              ...
              <div className="flex flex-row justify-end">
                <div className="messages text-sm text-white grid grid-flow-row gap-2">
                  <div className="flex items-center flex-row-reverse group">
                    <p className="px-6 py-3 rounded-t-full rounded-l-full bg-violet-primary max-w-xs lg:max-w-md">
                      Hey! How are you?
                    </p>
                    <button
                      type="button"
