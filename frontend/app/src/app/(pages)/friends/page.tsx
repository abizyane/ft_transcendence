...
const friends = () => {
  return (
    <div className=" w-3/4  p-6 mb-24 lg:mb-0">
      <h1 className="text-white text-center w-full text-4xl font-bold mb-6">Friends List</h1>
      <div className="bg-gray-800/65 rounded-xl border border-violet-primary grid grid-cols-1 lg:grid-cols-2 gap-6   h-[1100px] overflow-y-auto no-scrollbar p-4">
  ...
  >
    <svg
      ...
      height="2em"
      viewBox="0 0 24 24"
      fill="currentColor"  // Ensure the SVG inherits the current text color
    >
