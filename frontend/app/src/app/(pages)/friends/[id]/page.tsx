...
const Friends = () => {
  ...
  return (
    <div className="w-full lg:max-w-[1200px] p-2 mb-24 lg:h-full">
      ...
      <div className={`bg-gray-800/65 rounded-xl border w-full border-violet-primary ${listHeight} grid grid-cols-1 lg:grid-cols-2 gap-4  overflow-y-auto no-scrollbar p-41`}>
