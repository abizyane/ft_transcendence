        ...
        <div className="flex items-center justify-around w-full lg:flex lg:flex-col lg:items-end lg:w-20">
          <div className="flex flex-col items-center ">
            <img
              src={Profil.src}
              alt="Player 1"
              className="w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 object-cover rounded-full shadow-lg"
            />
        ...
        <div className="flex flex-col justify-center items-center gap-8 lg:gap-2 lg:flex-row lg:mt-6">
          <div className="flex flex-col items-center">
            <img
              ...
              className="w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 object-cover rounded-full shadow-lg"
            />
            <span className="text-white text-sm lg:text-base mt-2">Finalist 1</span>
          </div>
          <div className="flex flex-col items-center">
            <img
              src={Trophy.src}
              alt="Trophy"
              className="w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 object-cover rounded-full border border-violet-primary p-2"
            />
          ...
          <div className="flex flex-col items-center">
            <img
              src={Profil.src}
              alt="Finalist 2"
              className="w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 z-50 object-cover rounded-full shadow-lg"
            />
            <span className="text-white text-sm lg:text-base mt-2">Finalist 2</span>
          </div>
        </div>
