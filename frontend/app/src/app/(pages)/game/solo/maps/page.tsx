  ...
  return (
    <div className="h-[80%] gap-4 rounded-xl p-2 w-full flex flex-col items-center ">
      ...
      <div className="flex flex-col md:flex-row md:justify-center w-full h-[113%] md:h-[76%] lg:h-[85%] flex-none items-center ">
        ...
        >
          <Link
            href={{ pathname: "/game/solo/maps/matchmaking", query: { game, map: "mars", token }}}
        ...
        >
          <Link
            href={{ pathname: "/game/solo/maps/matchmaking", query: { game, map: "earth", token }}}
            className="h-full w-full"
          >
            <div
              className="h-full w-full bg-cover bg-center"
        ...
        >
          <Link
            href={{ pathname: "/game/solo/maps/matchmaking", query: { game, map: "jupiter", token }}}
            className="h-full w-full"
          >
            <div
              className="h-full w-full bg-cover bg-center"
